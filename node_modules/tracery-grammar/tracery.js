...
var universalModifiers = {
    ...
    // es function for third person present singular english verb conjugation added by Kalil Smith-Nuevelle

    es : function(s) {
        var last = s.charAt(s.length - 1);
        var secondLast = s.charAt(s.length - 2);
        ...
        switch(last) {
            case 's':
                ...
                //already conjugated...? probably shouldn't happen in english otherwise
                else {
                    return s;
                }
                break;
            ...
            case 'h':
                ...
                // also shouldn't happen in english
                else {
                    return s + 's';
                }
